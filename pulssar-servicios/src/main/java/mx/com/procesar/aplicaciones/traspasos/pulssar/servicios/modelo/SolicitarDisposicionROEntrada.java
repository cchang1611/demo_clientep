 ...
 *
 */
public class SolicitarDisposicionROEntrada  implements Serializable{
	 ...
	 */
	@JsonInclude(JsonInclude.Include.NON_EMPTY)
	private List<AccionSieforeIssste> accionesSiefore;
	...
	/**
	 * @return the accionesSiefore
	 */
	public List<AccionSieforeIssste> getAccionesSiefore() {
		return accionesSiefore;
	}



	/**
	 * @param accionesSiefore the accionesSiefore to set
	 */
	public void setAccionesSiefore(List<AccionSieforeIssste> accionesSiefore) {
		this.accionesSiefore = accionesSiefore;
	}
