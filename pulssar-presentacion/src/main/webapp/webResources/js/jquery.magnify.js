...
Magnify.prototype = {
  ...
  render: function () {
    ...
    var btnsTpl = {
      ...
      maximize: '<button class="magnify-button magnify-button-maximize" title="' +
        ...
        '</button>',
      close: '<button id="idMdl" class="magnify-button magnify-button-close" title="' +
  ...
  setImgTitle: function (url) {
    ...
    $('#idMdl').attr('onclick',"closedWindows("+this.groupData[index].mdl+")");		
    $('#idMdl').attr('id',"mdl"+this.groupData[index].mdl);
