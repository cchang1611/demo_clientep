function calculaRfc(inputNombre,inputPaterno,inputMaterno,inputNacimiento) {
    var objetoFecha = '';
//    var inputNombre = document.getElementById("nombre").value;
//    var inputPaterno = document.getElementById("aPaterno").value;
//    var inputMaterno = document.getElementById("aMaterno").value;
//    var inputNacimiento = document.getElementById("fechaNacimiento").value;
    
    //Fecha formato aaaa-mm-dd
    let arregloFecha = inputNacimiento.split("-");
    var anio = arregloFecha[0];
    var anioModificado = anio.substr(2,3);
    var mes = arregloFecha[1];
    var dia = arregloFecha[2];
    objetoFecha += anioModificado;
    objetoFecha += mes;
    objetoFecha += dia;

    

    var ap_paterno = inputPaterno;
    var ap_materno = inputMaterno;
...
function RFCQuitaProhibidas(rfc) {
    var res;
    rfc = rfc.toUpperCase();
    var strPalabras = "BUEI*BUEY*CACA*CACO*CAGA*CAGO*CAKA*COGE*COJA*";
    strPalabras = strPalabras + "KOGE*KOJO*KAKA*KULO*MAME*MAMO*MEAR*";
    strPalabras = strPalabras + "MEON*MION*COJE*COJI*COJO*CULO*";
