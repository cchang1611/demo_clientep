...
<head>
	<title>Reactivación de Usuarios</title>
	<meta charset="utf-8" />
	<![if IE]>
...
<body>
	...
	<div class="wrapper">
		<jsp:include page="../generales/headerAdmin.jsp">
			...
			<jsp:param name="menuTitle" value="Reactivaci&oacute;n de usuarios" />
		...
		<section>
			<form:form method="POST" id="fm_reactivacion" modelAttribute="reactivaUsuario" action="reactivaUsuario.do">
				<div class="Container">
						...
						<div class="Datos_Container">
							...
							<div class="SeccionTable">
								<div style="overflow-x: auto;">
									<table id="tablaReactiva" class="display">
										<thead>
											<tr class="RowHeader">
										...
										<tbody>
											<c:forEach items="${usuariosReactiva}" var="usuarios">
												<tr>
													<td></td>
													<c:choose>
							...
							<div class="Seccion02">
								<div class="ContainerButtonsCenter">
									<input id="btnReactiva" class="Submit Buttons2" type="submit" value="Reactivar">
									<input id="btnCancelar" class="Submit Buttons2" type="submit" value="Cancelar">
								</div>
							</div>
						</div>
					</div>
	...
	<script src="<c:url value='/webResources/js/usuariosReactiva.js'/>"></script>
