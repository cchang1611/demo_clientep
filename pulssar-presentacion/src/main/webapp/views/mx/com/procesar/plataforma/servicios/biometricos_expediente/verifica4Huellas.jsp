...
<body>
					...
					<c:otherwise>
						<div class="Container">
							<div class="Layout__XL">
								...
								<div class="Title" >
									<p>Trabajador validado</p>
								</div>
								<div class="Datos_Container">
									<div class="row_container">
										<div class="Datosxxl"><strong>Curp Empleado: </strong> ${curpTrabajador}</div>
										<div class="Datosxxl"><strong>Fecha Validación: </strong> ${fechaValidacionTrab}</div>
										<div class="Datosxxl"><strong>Vigencia: </strong> ${fechaVigenciaTrab}</div>
									</div>
								</div>
								<div class="ContainerButtonsCenter">
										<input id="btnRegresar" class="Submitxl" type="button" value="REGRESAR" />
									</div>
							</div>
						</div>
					</c:otherwise>
	...
	<script type="text/javascript" charset="UTF-8" src="<c:url value='/webResources/js/validarTrabajador.js'/>"></script>
