	...
	<div class="wrapper">
		...
		<!-- Inicia Wrapper -->
          ...
          <div class="Container">
            ...
            <form id="formAutenticacionIneFirmarPdf" action="./autenticacionIneFirmarPdf.do" method="post">
            <input id="inputfirma" name="firma" type="hidden" value="0"/>
              <div class="Line">
                <p></p>
              </div>
              ...
              <div class="ContainerButtons">
                <input id="btnFirmarPdfAutenticacioIne" class="Submit" type="button" value="Continuar Firmar" />
              </div>
              </form>
              </div>
            </div>
