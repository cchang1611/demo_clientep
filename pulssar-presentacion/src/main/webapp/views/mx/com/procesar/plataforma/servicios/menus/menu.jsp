...
<head>
	...
	<link rel="stylesheet" charset="utf-8" type="text/css" href="<c:url value='/webResources/css/general/universal_setting.css'/>"/>
	<link rel="stylesheet" charset="utf-8" type="text/css" href="<c:url value='/webResources/css/1.5.8/slick-theme.min.css'/>"/>
	<link rel="stylesheet" charset="utf-8" type="text/css" href="<c:url value='/webResources/css/1.5.8/slick.css'/>"/>
	<link rel="stylesheet" charset="utf-8" type="text/css" href="<c:url value='/webResources/css/general/container.css'/>"/>
	<link rel="stylesheet" charset="utf-8" type="text/css" href="<c:url value='/webResources/css/general/carousel/slick_carousel_administrador.css'/>"/>
	<link rel="stylesheet" charset="utf-8" type="text/css" href="<c:url value='/webResources/css/general/footer.css'/>"/>
...
<body>
	...
	<div class="wrapper">
		<jsp:include page="../generales/headerAdmin.jsp">
			...
			<jsp:param name="menuTitle" value="${sessionScope.tituloMenu}" />
		</jsp:include>
		<section>
			<div class="Container">
				<div class="MenuContainer">
					<c:choose>
						<c:when test="${sessionScope.menuUsuario != null}">
							
								<c:if test="${fn:length(sessionScope.menuUsuario) <= 4}">
								...
								<c:forEach items="${sessionScope.menuUsuario}" var="menu">								
	...
	<script type="text/javascript" charset="UTF-8" src="<c:url value='/webResources/js/menuPrincipal.js'/>"></script>
