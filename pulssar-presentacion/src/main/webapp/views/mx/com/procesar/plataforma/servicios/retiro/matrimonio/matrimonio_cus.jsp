...
<html xmlns="http://www.w3.org/1999/xhtml" lang="es">
   <head>
      ...
      <script type="text/javascript" charset="UTF-8" src="<c:url value='../webResources/js/matrimonio_cus.js'/>"></script>
   ...
   <body>
      ...
      <jsp:include page="../../generales/headerAgente.jsp">
         ...
         <jsp:param name="menuTitle" value="Ayuda de Matrimonio" />
      ...
      <div class="wrapper">
         <div class="Container">
            ...
            <div class="Container">
               <div class="Layout__M">
                  <form:form id="formSalida" method="post" action="${pageContext.request.contextPath}/private/capturaDatosConyuge.do" modelAttribute="salida">
                     <div class="Line"></div>
                     <div class="Datos_Container">
                        <div class="DatosBack">
                           <strong>CUS:</strong>
                           <p id="cusid">${datosRetiroParcialImss.cus}</p>
                        </div>
                        ...
                        <div class="DatosBack"><strong>TIPO DE PRESTACIÓN:</strong> RETIRO POR Matrimonio</div>
                     </div>
                     <div class="Line"></div>
                     <div class="Datos_Container">
                        <div class="DatosBack">
                           <strong>SELLO TRABAJADOR:</strong>
                     ...
                     <div class="ContainerButtonsCenter">
                        ...
                        <c:if test="${botoncertdisabled == true}">
                           <input id="btnSolicitar" class="Submitxl" type="button" value="Siguiente" />	
                        </c:if>
