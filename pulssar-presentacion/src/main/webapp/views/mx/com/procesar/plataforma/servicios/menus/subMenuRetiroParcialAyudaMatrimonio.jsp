         ...
         <div class="Banner__Container">
            <div class="Banner__Thumbnail">
               ...
               <div class="Banner__TextContainer">
                  <h1 class="Banner__TitleContainer">Ayuda de Matrimonio</h1>
               </div>
            </div>
         </div>
         <section>
...
<%--                      </c:if> --%>
		                     <div class="Icon"><img class="IconImgMenu" src="../webResources/img/icon_imss.png" alt="icon_menu"/></div>
      ...
      <script type="text/javascript" charset="UTF-8" src="<c:url value='/webResources/js/subMenuAyudaMatrimonio.js'/>"></script>
   </body>
</html>
