...
<head>
	<title>Solicitud recupera contraseña de Usuario</title>
	<meta charset="utf-8" />
...
<body>
	<div class="wrapper">
		...
		<jsp:include page="generales/headerPrincipal.jsp">
			...
			<jsp:param name="titulo" value="OLVIDE MI CONTRASE&Ntilde;A" />
		</jsp:include>
		<script type="text/javascript">
			var _FLUJO = "${respuesta.flujo}";
		</script>
		<section>
			<form:form id="fm_olvida" method="POST" modelAttribute="userOlvida" action="recuperaPassword.do">
				<div class="Container">
					<div class="Layout__M">
						<div class="Datos_Container">
							<div class="Form__Group">
								<label class="LabelText" for="usuario">Usuario: *</label>
								<form:input class="Inputxxl" type="text" id="numeroAgente" name="numeroAgente" path="nickUsuario" placeholder="Usuario" data-nombre="Usuario" data-not-null="0" data-usuario="0" maxlength="50" noPaste="true" />
							</div>
							<div class="Form__Group">
							...
							<div class="Form__Group">
								...
								<form:input id="email" class="Inputxxl" type="text" name="correo" path="correo" placeholder="Correo Electrónico" data-nombre="Correo Electrónico" data-email-opcional="0" maxlength="50" noPaste="true" />
							</div>
							...
							<div class="ContainerButtonsCenter">
								<input id="aceptar" class="Submit" type="submit" value="RECUPERAR">
							</div>
							<div class="Form__Group">
								<p class="Login__Parrafo">No te ha llegado un correo o sms, captura tu usuario y da clic <a class="Login__Forget" href="#" id="reenviar">aquí</a></p>
							</div>
						</div>
					</div>
				</div>
	...
	<script src="<c:url value='/webResources/js/recuperaPassword.js'/>"></script>
