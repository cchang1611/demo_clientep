...
<head>
	<title>Reenvio  de credenciales</title>
	<meta charset="utf-8" />
	<![if IE]>
...
<body>
	...
	<div class="wrapper">
		<jsp:include page="../generales/headerAdmin.jsp">
			...
			<jsp:param name="menuTitle" value="Reenv&iacute;o  de credenciales" />
		...
		<section>
			<form:form method="POST" id="fm_reenvio" modelAttribute="reenvioUsuario" action="reenviaUsuario.do">
				<div class="Container">
						...
						<div class="Datos_Container">
							...
							<div class="SeccionTable">
								<div style="overflow-x: auto;">
									<table id="tablaReenvia" class="display">
										<thead>
											<tr class="RowHeader">
										...
										<tbody>
											<c:forEach items="${usuariosReenvia}" var="usuarios">
												<tr>
													<td></td>
													<c:choose>
							...
							<div class="Seccion02">
								<div class="ContainerButtonsCenter">
								  <input id="btnReenvia" class="Submit" type="submit" value="Reenviar">
								</div>
							</div>
						</div>
					</div>
	...
	<script src="<c:url value='/webResources/js/usuariosReenvio.js'/>"></script>
