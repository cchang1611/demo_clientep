...
<body>
	...
	<div class="wrapper">
		<jsp:include page="../generales/headerAdmin.jsp">
			...
			<jsp:param name="menuTitle" value="Baja de Usuarios" />
		...
		<section>
			<form:form method="POST" id="fm_baja" modelAttribute="bajaUsuario" action="bajaUsuario.do">
				<div class="Container">
						...
						<div class="Datos_Container">
							...
							<div class="SeccionTable">
								<div style="overflow-x: auto;">
									<table id="tablaBaja" class="display">
										<thead>
											<tr class="RowHeader">
										...
										<tbody>
											<c:forEach items="${usuariosBaja}" var="usuarios">
												<tr>
													<td></td>
													<c:choose>
							...
							<div class="Seccion02">
								<div class="ContainerButtonsCenter">
								  <input id="btnBaja" class="Submit" type="submit" value="Dar de Baja">
								</div>
							</div>
						</div>
					</div>
	...
	<script src="<c:url value='/webResources/js/usuariosBaja.js'/>"></script>
