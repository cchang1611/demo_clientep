...
<body>
	<div class="wrapper">
		...
		<jsp:include page="generales/headerPrincipal.jsp">
			...
			<jsp:param name="titulo" value="CAMBIO DE CONTRASE&Ntilde;A" />
		</jsp:include>
		...
		<section>
			<form:form id="fm_activa" method="POST" modelAttribute="cambioPassword" action="guardarCambios.do" accept-charset="ISO-8859-1">
				<div class="Container">
					<div class="Layout__M">
						<div class="Datos_Container">
							...
							<div class="Form__Group">
								<label class="LabelText" for="usuario">Contrase&ntilde;a Actual: *</label>
								<form:input id="contraseniaActual" class="Inputxxl" type="password" name="passwordActual" path="passwordActual" data-not-null="0" placeholder="Password Actual" data-nombre="Contrase&ntilde;a Actual" data-contrasenia="0" maxlength="13" noPaste="true" />
							</div>
							<div class="Form__Group">
							...
							<div class="Form__Group">
								...
								<form:input id="confirmaContrasenia" class="Inputxxl" type="password" name="confirmarPassword" path="confirmarPassword" placeholder="Confirmar Password Nuevo" data-nombre="Confirma Contrase&ntilde;a Nueva" data-confirm="confirmaContrasenia" data-contrasenia="0" maxlength="13" noPaste="true" />
							</div>
							<div class="Form__Group">
							...
							<div class="ContainerButtonsCenter">
								<input id="aceptar" class="Submit" type="submit" value="Aceptar">
							</div>
							<div id="enlaceRecuperacion" class="Form__Group">
								<p class="Login__Parrafo">Tu c&oacute;digo no ha llegado, da clic <a class="Login__Forget" href="#" id="reenviarRecuperacion">aqu&iacute;</a></p>
							</div>
						</div>
					</div>
				</div>
