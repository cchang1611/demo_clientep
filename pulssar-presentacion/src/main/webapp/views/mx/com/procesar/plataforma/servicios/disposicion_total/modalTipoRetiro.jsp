			...
			<div class="Container_Section">
				<div class="row_containerbox">
					...
					<div class="Form__Group">
						...
						<input class="InputEdit " type="text" onclick="activar_boton()" name="clabeTipoRetiro"  value="" placeholder="" id="clabeTipoRetiro" data-clabe="0" data-nombre="campo Clabe" required="required" />
					    <!--  <div id="mensajeErrorClabe"></div>  -->
					</div>
					<div class="Form__Group">
						<label class="LabelTextEdit" for="cuentaTipoRetiro">Cuenta:</label>
						<input class="InputEdit" type="text" onkeyup="activar_boton()" name="cuentaTipoRetiro" value="" placeholder="" id="cuentaTipoRetiro" data-numeros="0"  data-nombre="campo Cuenta" required="required" />
					</div>
					</div>
				</div>
			</div>
