	...
	<body>
	    ...
	    <form:form id="fm_recepcionImagen" modelAttribute="parametrosRetiroParcialCalculoImss" action="tipoRetiroMatrimonio.do">
	                ...
	                <div class="Container_Section">
	                    <div class="row_containerbox">
	                        <div class="Form__Group">
	                            ...
	                            <select class="Select" id="formaPagoTipoRetiro"  name="formaPagoTipoRetiro" data-not-null="0" data-nombre="Forma de Pago">
	                        ...
	                        <div id="formaPagoTransferencia">
	                            ...
	                            <div class="Form__Group">
	                                ...
	                                <input class="InputEdit" type="text" name="clabeTipoRetiro" id="clabeTipoRetiro" required="required" autocomplete="off" maxlength="18" />
<!-- 	                                    <button class="Submitx" type="button" onclick="buscarIntitucionBancaria()" style="display:inline;"> -->
<!-- 	                                        Buscar -->
<!-- 	                                    </button> -->
	                                <div class='text_error' style="color:red" id="mensajeErrorClabe"></div>
	                            </div>
	                            <div class="Form__Group">
									<label class="LabelTextEdit" for="cuentaTipoRetiro">Cuenta:</label>
									<input class="InputEdit" type="text" onkeyup="activar_boton()" name="cuentaTipoRetiro" id="cuentaTipoRetiro" data-numeros="0"  data-nombre="campo Cuenta" required="required" autocomplete="off" maxlength="11" readonly="readonly" disabled="disabled"/>
								</div>
	                        </div>
	            ...
	            <div class="ContainerButtons">
	                <input type="button" class="Submitx_disabled" id="btnPopupAceptar" value="Aceptar" disabled style="margin: 20px"/>
	                <input type="button" class="Submitx" value="Cancelar" id="btnPopupCancelar" style="margin: 20px"/>
	            </div>
